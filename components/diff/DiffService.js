(function() {
  ...
  module.provider('diffService', function() {
	  ...
	  this.performDiff = function(repo, from, to) {
        adds = [{repo:'repo1', layer:'layer1', feature:'fid-34f32ac32'}];
        modifies = [{repo:'repo1', layer:'layer1', feature:'fid-ffc2380ba'},
                   {repo:'repo1', layer:'layer2', feature:'fid-87291defa'}];
        deletes = [{repo:'repo1', layer:'layer2', feature:'fid-23cdfa320'}];
